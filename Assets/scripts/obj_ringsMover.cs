...
public class obj_ringsMover : MonoBehaviour {
            ...
            if (Time.time > nextUsage) //continue scrolling
             ...
             //       ps.emit = true;
                ...
                if (countDelay>5)
                {
                    if (countDelay==6)
                    {
                        GameObject PoopPEE = Instantiate(Resources.Load("galaxyBoom")) as GameObject;
                        PoopPEE.name = gameObject.name;
                        PoopPEE.transform.localScale = this.transform.localScale;
                        PoopPEE.transform.position = this.transform.position;
