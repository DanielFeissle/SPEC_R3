...
public class hand_placer : MonoBehaviour {
  ...
  private  void spawnPhaseOne()
    ...
    bool left1=false, right1=false, left2=false;
    private Rigidbody2D rb;
    Renderer m_Renderer;
    private Camera cam;

    IEnumerator HandMoveLeft()
    {
        ...
        while (this.transform.position.x > p.x - m_Renderer.bounds.size.x)
        {
            exp1 = Resources.Load<AudioClip>("_FX\\SFX\\wee");
            AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
            yield return new WaitForSeconds(0.01f);
            rb.AddForce(new Vector2(-5.75f, 0.0f));
            if ((this.transform.position.x >= -.55f && this.transform.position.x<=.55f) && left1==false)
            {
                exp1 = Resources.Load<AudioClip>("_FX\\SFX\\muhahaha");
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
    ...
    IEnumerator HandMoveRight()
    {
        ...
        while (this.transform.position.x < q.x + m_Renderer.bounds.size.x) 
        {
            exp1 = Resources.Load<AudioClip>("_FX\\SFX\\wee");
            AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
            yield return new WaitForSeconds(0.01f);
            rb.AddForce(new Vector2(5.75f, 0.0f));
            if ((this.transform.position.x >= -.55f && this.transform.position.x <= .55f) && right1 == false)
            {
                right1 = true;
                exp1 = Resources.Load<AudioClip>("_FX\\SFX\\lameAGH4");
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
    ...
    IEnumerator HandMoveLeft2()
    {
        ...
        while (this.transform.position.x > p.x-m_Renderer.bounds.size.x)
        {
            ...
            yield return new WaitForSeconds(0.01f);
            rb.AddForce(new Vector2(-5.75f, 0.0f));
            if ((this.transform.position.x >= -.55f && this.transform.position.x <= .55f) && left2 == false)
            {
                left2 = true;
                exp1 = Resources.Load<AudioClip>("_FX\\SFX\\HAHA");
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
                AudioSource.PlayClipAtPoint(exp1, new Vector3(transform.position.x, transform.position.y, 0.0f));
  ...
  public  int placePhase = 0;
	...
	void Update () {
        ...
        if (GameObject.Find("Main Camera").GetComponent<story_INTERDemo>().storyPhase==1)
        {

            if (placePhase==0)
            {
                placePhase = 1;
                StartCoroutine(HandMoveLeft());
